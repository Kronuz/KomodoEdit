        ...
        if not gset:
            ...
            for i in range(len(gset[0].setnumbers)):
                ...
                if inall and len(Canonical[i]) == gsetlen:
                    setnumber = i
                    # Note: DB. I added this to improve performance.
                    break
                    # Not sure if this breaks the algorithm (it doesn't appear
                    # to).
                ...
                if item.lr_index < len(item.prod) - 1:
                    for lookahead in item.lookaheads[setnumber]:
                        ...
                        if lookahead != '#':
                            ...
                            if next:
                                propogate.append(
                                    ((kitem, setnumber), (next, goto_setnumber)))
    ...
    for I in C:
        ...
        for p in I:
            try:
                        ...
                        for i in ancestors:
                            for s in K:
                                if i in s:
                                        ...
                                        if r is not None:
                                            ...
                                            if r > 0:
                                                ...
                                                if oldp.line > pp.line:
                                                    ...
                                                    n_rrconflict += 1
                                                    _vfc.write(
                                                        "reduce/reduce conflict in state %d resolved using rule %d.\n" % (st, actionp[st, a].number))
                                                    _vf.write(
                                    ...
                                    # break out of the for s in K loop because
                ...
                six.reraise(YaccError, "Hosed in lalr_parse_table", e)
